...
STAGE3_CFLAGS += -flto=2 -frandom-seed=1
override STAGEtrain_CFLAGS := $(filter-out -flto=2,$(STAGEtrain_CFLAGS))
STAGEtrain_GENERATOR_CFLAGS += -flto=2 -frandom-seed=1
STAGEfeedback_CFLAGS += -flto=2 -frandom-seed=1
